...
function withChatkitOneToOne(WrappedComponent) {
  var WithChatkitOneToOne = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(WithChatkitOneToOne, [{
      ...
      key: "_connectToRoom",
      value: function _connectToRoom() {
        var _this2 = this;

        this._currentUserId = this.context.chatkit.currentUser.id;
        this._roomId = (0, _utils.makeOneToOneRoomId)(this._currentUserId, this._otherUserId);
        var alreadyInRoom = this.context.chatkit.currentUser.rooms.some(function (r) {
          return r.id === _this2._roomId;
        });
        (alreadyInRoom ? Promise.resolve() : this.context.chatkit.currentUser.serverInstanceV6.request({
          method: "post",
      ...
      key: "_disconnectFromRoom",
      value: function _disconnectFromRoom() {
        ...
        return _react["default"].createElement(WrappedComponent, _extends({
          chatkit: _objectSpread({}, this.context.chatkit, {
            ...
            sendSimpleMessage: function sendSimpleMessage(options) {
              return _this4._sendSimpleMessage(options);
            },
            sendMultipartMessage: function sendMultipartMessage(options) {
              return _this4._sendMultipartMessage(options);
            },
            sendTypingEvent: function sendTypingEvent(options) {
              return _this4._sendTypingEvent(options);
            },
            setReadCursor: function setReadCursor(options) {
              return _this4._setReadCursor(options);
            }
          })
        }, forwardedProps));
      }
